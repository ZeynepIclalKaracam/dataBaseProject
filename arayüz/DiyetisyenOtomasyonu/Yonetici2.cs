...
namespace DiyetisyenOtomasyonu
{
    public partial class Yonetici2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            baglan.Open();
            if (rbAdet.Checked) {
                komut = new SqlCommand("Update tblYiyecekler set Tur='" + tur + "',Yiyecek='" + yiyecek + "',Kalori='" + kalori + "',Tur_id='" + tur_id +"',Miktar='"+miktar+"',Miktar_id='"+"1"
                    + "'where id="+ dataGridView1.CurrentRow.Cells["id"].Value.ToString(), baglan);


                komut.ExecuteNonQuery(); }
            else
            {
                komut = new SqlCommand("Update tblYiyecekler set Tur='" + tur + "',Yiyecek='" + yiyecek + "',Kalori='" + kalori + "',Tur_id='" + tur_id + "',Miktar='" + miktar + "',Miktar_id='" + "2" + "' where id=" 
                    + dataGridView1.CurrentRow.Cells["id"].Value.ToString(), baglan);
