...
namespace DiyetisyenOtomasyonu
{
    ...
    {
        SqlConnection baglan = new SqlConnection("Server=LAPTOP-S5FKN8GQ\\SQLEXPRESS;Database=Kalori;Integrated Security=True");
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                int cinsiyet = 1;
                komut = new SqlCommand("Update tblBilgiler set kAdi='" + kAdi + "',sifre='" + sifre + "',adi='" + adi 
                    + "',soyadi='" + soyadi + "',kilo='" + kilo + "',boy='" + boy + "',yas='" + yas + "',cinsiyet='" 
                    + cinsiyet + "',egzersiz='" + egzersiz + "'where uye_id=" + dataGridView1.CurrentRow.Cells["uye_id"].Value.ToString(), baglan);
                komut.ExecuteNonQuery();
            ...
            {
                int cinsiyet = 2;
                komut = new SqlCommand("Update tblBilgiler set kAdi='" + kAdi + "',sifre='" + sifre + "',adi='" 
                    + adi + "',soyadi='" + soyadi + "',kilo='" + kilo + "',boy='" + boy + "',yas='" + yas + "',cinsiyet='" + cinsiyet
                    + "',egzersiz='" + egzersiz + "'where uye_id="+dataGridView1.CurrentRow.Cells["uye_id"].Value.ToString(), baglan);
                komut.ExecuteNonQuery();
            }
            baglan.Close();
            DatagridYenile();
