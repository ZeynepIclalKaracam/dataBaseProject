...
namespace DiyetisyenOtomasyonu
{
    public partial class Bilgiler : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                int cinsiyet = 1;
                komut = new SqlCommand("Update tblBilgiler set sifre='" + sifre + "',adi='" + adi + "',soyadi='" + soyadi + "',kilo='" + kilo + "',boy='" 
                    + boy + "',yas='" + yas + "',cinsiyet='" + cinsiyet + "',egzersiz='" + egzersiz + "'where uye_id=" + dataGridView1.CurrentRow.Cells["uye_id"].Value.ToString(), baglan);
            ...
            {
                int cinsiyet = 2;
                komut = new SqlCommand("Update tblBilgiler set sifre='" + sifre + "',adi='" + adi + "',soyadi='" + soyadi + "',kilo='" + kilo + "',boy='" + boy + "',yas='" + yas 
                    + "',cinsiyet='" + cinsiyet + "',egzersiz='" + egzersiz + "'where uye_id=" + dataGridView1.CurrentRow.Cells["uye_id"].Value.ToString(), baglan);
                komut.ExecuteNonQuery();
            }
            baglan.Close();
            DatagridYenile();
